...
package com.jozibear247_cab.driver.maputills;

import static com.jozibear247_cab.driver.maputills.MathUtil.EARTH_RADIUS;
import static com.jozibear247_cab.driver.maputills.MathUtil.clamp;
import static com.jozibear247_cab.driver.maputills.MathUtil.hav;
import static com.jozibear247_cab.driver.maputills.MathUtil.havDistance;
import static com.jozibear247_cab.driver.maputills.MathUtil.havFromSin;
import static com.jozibear247_cab.driver.maputills.MathUtil.inverseMercator;
import static com.jozibear247_cab.driver.maputills.MathUtil.mercator;
import static com.jozibear247_cab.driver.maputills.MathUtil.sinFromHav;
import static com.jozibear247_cab.driver.maputills.MathUtil.sinSumFromHav;
import static com.jozibear247_cab.driver.maputills.MathUtil.wrap;
...
public class PolyUtil {
			...
			for (LatLng point2 : poly) {
				...
				if (max(lat1, lat2) >= minAcceptable
					...
					for (double x3 : xTry) {
						...
						double t = len2 <= 0 ? 0 : clamp((x3 * x2 + (y3 - y1)
								* dy)
								/ len2, 0, 1);
						double xClosest = t * x2;
						double yClosest = y1 + t * dy;
						double latClosest = inverseMercator(yClosest);
						double havDist = havDistance(lat3, latClosest, x3
								- xClosest);
	...
	private static boolean isOnSegmentGC(double lat1, double lng1, double lat2,
		...
		double sinSumAlongTrack = sinSumFromHav(havAlongTrack13,
				havAlongTrack23);
