...
import static com.jozibear247_cab.driver.maputills.MathUtil.arcHav;
...
public class SphericalUtil {
	...
	public static double computeHeading(LatLng from, LatLng to) {
		...
		double heading = atan2(sin(dLng) * cos(toLat), cos(fromLat)
				* sin(toLat) - sin(fromLat) * cos(toLat) * cos(dLng));
	 ...
	 */
	private static double polarTriangleArea(double tan1, double lng1,
			double tan2, double lng2) {
